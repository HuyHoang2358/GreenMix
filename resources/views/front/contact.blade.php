    ...
    <div class="grid grid-cols-5 bg-[#F8F8F8] px-72 py-10 mt-16">
        ...
        <div class="col-span-2 bg-primary px-10 py-16">
            ...
            <div class="py-8 flex flex-col gap-5">
                <input type="text" class="rounded-lg outline-none border border-white pl-4" placeholder="Tên công ty" name="nameCompany">
                ...
                <textarea rows="5" class="rounded-lg outline-none border border-white pl-4" placeholder="Nội dung" name="detail"></textarea>
            </div>
            <a href="#"><p class="text-white font-semibold text-xl w-full text-center py-3 border-2 border-white rounded-xl">GỬI YÊU CẦU</p></a>
        </div>
    </div>
@endsection
