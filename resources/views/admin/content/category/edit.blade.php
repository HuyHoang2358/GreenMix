...
@section('breadcrumb')
    <nav aria-label="breadcrumb" class="-intro-x h-[45px] mr-auto">
        <ol class="breadcrumb breadcrumb-light">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('admin.category.edit',[$type, $item->id])}}">Chỉnh sửa thông tin</a></li>
        </ol>
    </nav>
@endsection
@section('content')
    ...
    <form action="{{route('admin.category.update', [$type, $item->id])}}" method="post">
        @csrf
                ...
                <div class="mt-5">
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="category-name" name="name" type="text" class="form-control" placeholder="Nhập tên danh mục" required autofocus value="{{$item->name}}">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="category-slug" name="slug" type="text" class="form-control" placeholder="Nhập slug của tên danh mục" value="{{$item->slug}}">
                            <div class="form-help text-right">Tối đa 0/100 ký tự</div>
                        </div>
                    </div>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <select id="parent-category" name="parent_id" class="form-select">
                                ...
                                @endif
                                @include('admin.content.category.option', ["categories" =>$categories, 'level' => 0, 'parent_id' => $item->parent_id])
                            </select>
                        </div>
                    </div>
