...
@section('title', $isUpdate ? 'Cập nhật tài khoản' : 'Thêm mới tài khoản')
@section('breadcrumb')
...
@section('content')
    ...
    <!-- Title page -->
    @include('admin.common.titleForm', ['titleForm' =>  $isUpdate ? 'Cập nhật tài khoản' : 'Thêm mới tài khoản'])

     <!-- Form update information -->
    @php($actionRoute = $isUpdate ? route('admin.account.update', ['id' => $item->id]) : route('admin.account.store'))
    ...
    <form action="{{ $actionRoute }}" method="POST">
                ...
                <div class="mt-5">
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="name" name="name" type="text" class="form-control" placeholder="Nhập họ và tên" required autofocus value="{{ isset($item) ? $item->name : ''}}">
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input required id="email" name="email" type="email" class="form-control" placeholder="Nhập email của tài khoản" value="{{ isset($item) ? $item->email : ''}}">
        ...
        @include('admin.common.cancelAndSaveButtons', ['routeCancel' => route('admin.account.index')])
