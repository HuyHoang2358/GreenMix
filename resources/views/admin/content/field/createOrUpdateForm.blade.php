...
@section('title', 'Thêm mới thông tin lĩnh vực kinh doanh')
@section('breadcrumb')
...
@section('content')
    ...
    @include('admin.common.titleForm', [
        'titleForm' => $isUpdate ? 'Cập nhật thông tin lĩnh vực kinh doanh' : 'Thêm mới thông tin lĩnh vực kinh doanh',
    ])

    <!-- Form update information -->
    @php($actionRoute = $isUpdate ? route('admin.field.update', ['id' => $item->id]) : route('admin.field.store'))
                        ...
                        <div class="form-label xl:w-64 xl:!mr-10">
                            <div class="text-left">
                                <div class="flex items-center">
                                    <div class="font-medium">Tên lĩnh vực kinh doanh</div>
                                    <div class="ml-2 px-2 py-0.5 bg-slate-200 text-slate-600 dark:bg-darkmode-300 dark:text-slate-400 text-xs rounded-md">
                                        Bắt buộc
                                    </div>
                                </div>
                                <div class="leading-relaxed text-slate-500 text-xs mt-3"> Tên lĩnh vực kinh doanh không nên trùng lặp, ngắn gọn, dễ hiểu</div>
                            </div>
                        </div>
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="name" name="name" type="text" class="form-control"
                                   placeholder="Nhập tên lĩnh vực kinh doanh" required autofocus
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="slug" name="slug" type="text" class="form-control"
                                   placeholder="Nhập slug lĩnh vực kinh doanh" autofocus value="{{ isset($item) ? $item->slug : '' }}">
                            <div class="form-help text-right">Tối đa
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        <div class="form-label xl:w-64 xl:!mr-10">
                            <div class="text-left">
                                ...
                                <div class="leading-relaxed text-slate-500 text-xs mt-3">Cung cấp chi tiết về lĩnh vực kinh doanh cho người dùng dễ hiểu</div>
                            </div>
                        </div>
                        <div class="w-full mt-3 xl:mt-0 flex-1">
