                    ...
                    <div class="grid grid-cols-4 mt-5 gap-16">
                        <div class="w-full mt-3 xl:mt-0 gap-10 col-span-3">
                            ...
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="partner-url" type="text" class="form-control" value="{{$partner->url}}" onkeyup="handleCountNumberCharacter('partner-url', 'number-character-partner-url', 200)" name="url">
