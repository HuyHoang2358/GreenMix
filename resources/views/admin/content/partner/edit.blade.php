                ...
                <div class="mt-5">
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="partner-name" type="text" class="form-control" value="{{$partner->name}}" onkeyup="handleCountNumberCharacter('partner-name', 'number-character-partner-name', 255)" name="name" required autofocus>
                    ...
                    <div class="grid grid-cols-4 mt-5 gap-16">
                        <div class="w-full mt-3 xl:mt-0 gap-10 col-span-3">
                            ...
                            <div>
                                <div id="image" class="input-group flex gap-2">
                                    ...
                                    <input id="partner-logo" readonly="" type="text" value="{{$partner->logo}}" class="form-control" name="logo" required>
                                </div>
                            </div>
                            <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                                <div class="form-label xl:w-64 xl:!mr-10">
                                ...
                                <div class="w-full mt-3 xl:mt-0 flex-1">
                                    <input id="partner-url" type="text" class="form-control" value="{{$partner->url}}" onkeyup="handleCountNumberCharacter('partner-url', 'number-character-partner-url', 200)" name="url" required>
                        ...
                        <div class="col-span-1">
                            ...
                            <div id="holder" style="margin-top:15px">
                                <img class="w-52" src="{{$partner->logo}}" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="partner-order" type="number" class="form-control" value="{{$partner->order}}" name="order" required>
                        </div>
                    </div>
                </div>
            </div>
