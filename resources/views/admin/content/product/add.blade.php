...
@section('content')
    ...
    <form id="product-post" action="{{ route('admin.product.store') }}" method="POST" class="required-form">
        @csrf
        <div class="intro-y box p-5 mt-5">
                ...
                <div class="mt-5">
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="name" name="name" type="text" class="form-control" placeholder="Nhập tên sản phẩm" required autofocus>
                            <div class="form-help text-right">Tối đa <span class="word-counter" input-to-count="name" max-characters="255">0</span>/255 ký tự</div>
                        </div>
                    </div>
                    ...
                    <div class="form-inline items-start flex-col xl:flex-row mt-5 pt-5 first:mt-0 first:pt-0">
                        ...
                        <div class="w-full mt-3 xl:mt-0 flex-1">
                            <input id="slug" name="slug" type="text" class="form-control" placeholder="Nhập slug sản phẩm" autofocus>
                            <div class="form-help text-right">Tối đa <span class="word-counter" input-to-count="slug" max-characters="100">0</span>/100 ký tự</div>
                        </div>
                    </div>
                        ...
                        <div class="w-full flex flex-col gap-2">
                            <div class="flex-1">
                                <div class="w-full mt-3 xl:mt-0 flex-1 flex gap-2">
                                    ...
                                    <input id="image" name="images" type="text" class="form-control flex-1 w-2 readonly" placeholder="Tải hình ảnh lên" required autofocus />
                                </div>
                            </div>
            ...
            <div class="border border-slate-200/60 dark:border-darkmode-400 rounded-md p-5 mt-5">
                <div class="font-medium text-base flex items-center justify-between border-b border-slate-200/60 dark:border-darkmode-400 pb-5">
                    Bài viết sản phẩm
                    <div>
                        <input class="mx-2" type="checkbox" id="togglePostFields" name="togglePostFields" /> Liên kết bài viết
                    </div>
                </div>
                        ...
                        <div id="input" class="p-5 grid grid-cols-2 gap-5">
                            <div class="preview flex flex-col gap-2">
                                <div>
                                    ...
                                    <input readonly required id="type" name="type" type="text" class="form-control" value="Sản phẩm">
                                </div>
                                <div>
                                    <label for="add-post-image" class="form-label">Hình ảnh<span style="color: red;"> *</span></label>
                                    <div id="add-post-image" class="input-group flex gap-2">
                                        <span class="input-group-btn">
                                            <a id="add-post-img-preview" data-input="add-post-thumbnail" data-preview="add-post-holder" class="btn btn-primary flex gap-1">
                                                <i data-lucide="image"></i> Chọn
                                            </a>
                                        </span>
                                        <input id="add-post-thumbnail" class="form-control readonly" type="text" name="post-thumbnail" placeholder="Thêm ảnh cho bài viết">
                                    </div>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="intro-y box">
                            <div class="p-5 flex flex-col gap-2">
                                <div>
                                    ...
                                    <input id="post-name" name="post-name" type="text" class="form-control" placeholder="Nhập tên">
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <input id="post-slug" name="post-slug" type="text" class="form-control" placeholder="Nhập slug">
                                </div>
                                <div>
                                    <label for="description" class="form-label">Mô tả<span style="color: red;"> *</span></label>
                                    <textarea id="post-description" class="form-control h-20" name="post-description" placeholder="Nhập mô tả" style="resize: none;"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="intro-y box">
