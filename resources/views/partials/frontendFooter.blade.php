<div class="bg-footer-gray py-10 pl-52 pr-28">

    <div class="grid grid-cols-3 gap-x-20">
        <div class="flex flex-col gap-4">
            <img style="max-height: 57px; max-width: 180px;" src="{{ asset('images/logo/green-mix-logo.png') }}" alt="">
            <h1 class="uppercase font-semibold text-primary text-xl">CÔNG TY CỔ PHẦN ĐẦU TƯ SX & TM GREEN MIX</h1>
        ...
        <div class="text-white items-center">
            ...
            <ul class="list-disc ml-4 mt-6 flex gap-5 flex-col">
